...
payment_choice = [('Token', 'Token'), ('Follow Up', 'Follow Up'), ('FOC', 'FOC')]
follow_choice = [(10, 10), (15, 15), (20, 20), (30, 30), (45, 45), (60, 60)]
...
class Patient(models.Model):
    ...
    comorbidities = models.ForeignKey(Comorbiditie, on_delete=models.PROTECT)
