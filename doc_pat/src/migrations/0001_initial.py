# Generated by Django 3.1.2 on 2022-03-31 19:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prescription', models.TextField(default='', max_length=4000)),
                ('previous_prescription_data', models.TextField(default='')),
                ...
                ('procedure', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='src.procedures')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
